...
namespace TSP.DataManager.TechnicalServices
{
    ...
    public class ObserverWorkRequestManager : BaseObject
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable SelectForObserverWorkRequest(int ProjectId, int PrjReqId)
        {
            //   DataTable dt = new DataTable();
            SqlDataAdapter adapter = new SqlDataAdapter("SelectForObserverWorkRequest", this.Connection);
            adapter.SelectCommand.CommandTimeout = 0;
            adapter.SelectCommand.CommandType = CommandType.StoredProcedure;
            adapter.SelectCommand.Parameters.AddWithValue("@ProjectId", ProjectId);
            adapter.SelectCommand.Parameters.AddWithValue("@PrjReqId", PrjReqId);
            adapter.Fill(this.DataTable);
