...
namespace TSP.DataManager.TechnicalServices
{
    public class ProjectManager : BaseObject
    {
        ...
        /// دریافت لیست پروژه های ارسالی از شهرداری که هنوز ثبت نشده اند
        /// </summary>     
        /// <returns></returns>
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public DataTable GetShahrdariProjectForInsert()
        {
            DataTable dt = new DataTable();
            SqlDataAdapter adapter = new SqlDataAdapter("spGetShahrdariProjectForInsert", this.Connection);
            adapter.SelectCommand.CommandType = CommandType.StoredProcedure;
            //adapter.SelectCommand.Transaction = this.Transaction;
            adapter.Fill(dt);
            return dt;
        ...
        /// <summary>
        /// Write By AR.Ahmadpour
        /// دریافت اطلاعات کامل یک پروژه ارسالی از شهرداری که هنوز ثبت نشده اند
        /// </summary>     
        /// <returns></returns>
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public DataTable GetOneShahrdariProjectForShow(long ProjID)
        {
            DataTable dt = new DataTable();
            SqlDataAdapter adapter = new SqlDataAdapter("spGetOneShahrdariProjectForShow", this.Connection);
            adapter.SelectCommand.CommandType = CommandType.StoredProcedure;
            adapter.SelectCommand.Parameters.AddWithValue("@Pid", ProjID);
            adapter.Fill(dt);
            return dt;
        ...
        public void UpdateProjectIdInShahrdari(long ProjID,long ShahrdariProjID)
        {

            SqlCommand cmd=new SqlCommand("UpdateProjectIdInShahrdari", this.Connection);                
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@ProjID", ProjID);
            cmd.Parameters.AddWithValue("@ShahrdariProjID", ShahrdariProjID);
