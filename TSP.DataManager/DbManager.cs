...
namespace TSP.DataManager
{
    public class DBManager
    {
        ...
        private static string primaryCnn = "Connect Timeout=3600;Pooling=true; Data Source =192.168.0.128; Initial Catalog =NezamFars; User Id =WebsiteUser; Password =1234567890;Connect Timeout=120";
            ...
            get
            {
                if (_cnnStr == null)
                {
                    try
                    {
                        ...
                        _cnnStr = "Connect Timeout=6000;Pooling=true; Data Source =.; Initial Catalog =NezamFars; User Id =sa; Password =1234567890";
                    }
                    catch
                    {
